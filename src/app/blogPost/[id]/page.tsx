    ...
    <div className="container mx-auto py-10 px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {posts.map((post) => {
          ...
          const imageUrl = post.imageUrl?.trim() ? post.imageUrl : null; // If image URL is invalid, set to null
            ...
            >
              <div className="relative mb-6">
                {imageUrl ? (
                  ...
                  <div className="w-full h-48 bg-gray-300 rounded-lg mb-4 flex justify-center items-center text-white text-xl">
                    No Image Available
                  </div>
                )}
